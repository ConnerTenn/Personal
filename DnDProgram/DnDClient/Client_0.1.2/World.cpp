...
void DnD::World::Draw(Environment *activeEnvironment)
{
...

	{
		...
		ParentWindow->WindowSurface->DrawEllipse(pos - dimensions, pos + dimensions, { 255,0,0 }, Selected ? 3 : 0.5f);
		dimensions = (Double2(max(5, 10 * Scale), max(5, 10 * Scale))).ToInt2();
		ParentWindow->WindowSurface->FillEllipse(pos - dimensions, pos + dimensions, { 255,0,0,150 });
	}
