...
void DnD::Player::Draw(Surface *surface, World *world)
{
	...
	surface->FillEllipse(pos - dimensions, pos + dimensions, { ObjectColour.R,ObjectColour.G,ObjectColour.B,150 });

	dimensions = MeasureString(surface, Name, Font("consolas", 7, { 255,255,255 }));
	surface->DrawText(world->Transform(Position - dimensions / 2).ToInt2(), Name, Font("consolas", float(7 * world->Scale), { 255,255,255 }, Selected == SubSelected ? WL_UNDERLINE : 0));
