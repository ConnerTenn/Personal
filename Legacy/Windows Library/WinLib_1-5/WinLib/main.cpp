...
INT WINAPI WinMain(HINSTANCE HInstance, HINSTANCE, PSTR, INT iCmdShow)
{
	...
	textbox = new TextBox(10, 200, 400, 100, &win);
...
DrawText\n\
\n\
[conner@winlib]$ \v", Font(Colour(0, 255, 0)));
			container3->DrawText(300, 100, "DeltaTime:" + std::to_string(win2.Delta) + "ms", Font("Consolas", 15, 0, Colour(0, 255, 0)));
			container3->DrawText(300, 130, "X:" + std::to_string(win2.Input->MouseState.X) + "\nY:" + std::to_string(win2.Input->MouseState.Y), Font("Consolas", 15, 0, Colour(0, 255, 0)));
